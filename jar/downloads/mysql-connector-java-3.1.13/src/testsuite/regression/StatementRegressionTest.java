...
public class StatementRegressionTest extends BaseTestCase {
	...
	/**
	 * Tests fix for BUG#17587 - clearParameters() on a closed prepared statement
	 * causes NPE.
	 * 
	 * @throws Exception if the test fails.
	 */
	...
	/**
	 * Tests fix for BUG#18740 - Data truncation and getWarnings()
	 * only returns last warning in set.
	 * 
	 * @throws Exception if the test fails.
	 */
