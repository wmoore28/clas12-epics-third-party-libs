...
1.5.1. Common Problems and Solutions
   ...
   When I try to connect to the database with MySQL Connector/J, I
...
Warning
   ...
   My application throws an SQLException 'No Suitable Driver'. Why is
   this happening?
   ...
   I'm trying to use MySQL Connector/J in an applet or application
...
. .
   ...
   I'm trying to use JDBC-2.0 updatable result sets, and I get an
...
1.5.2. How to Report Connector/J Bugs or Problems
   ...
   email to security@mysql.com (mailto:security@mysql.com).
...
1.6.8. Changes in MySQL Connector/J 3.1.7-stable (18 February 2005)
     ...
     * PreparedStatements not creating streaming result sets.
       (Bug#8478: http://bugs.mysql.com/8478)
     ...
     * ResultSet.getBigDecimal() throws exception when rounding would
       ...
       (Bug#8484: http://bugs.mysql.com/8484)
...
1.6.15. Changes in MySQL Connector/J 3.1.0-alpha (18 February 2003)
...
1.6.18. Changes in MySQL Connector/J 3.0.15-production (04 September
2004)
